          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-4 md:space-y-6 animate-fade-in order-2 lg:order-1">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-heading font-bold leading-tight">
                Master Conversational <span className="text-gradient">German</span>
                <br />
            ...
            <div className="relative flex items-center justify-center order-1 lg:order-2 animate-scale-in mb-8 lg:mb-0 mt-16 md:mt-20 lg:mt-0">
